...
public class UserTransactionsDTO {
    ...
    public UserTransactionsDTO(Long id, Double transactionAmount, String transactionType, Date transactionDate, String transactionBy, UserLoginInfo userLoginInfo) {
        this.id = id;
